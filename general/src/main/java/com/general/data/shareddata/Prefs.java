package com.general.data.shareddata;
...
public final class Prefs {
    ...
    /**
     * @return Returns a map_aya containing a list of pairs key/value representing
     * the preferences.
    ...
    public static void putLongNow(final String key, final long value) {
    ...
    public static void putIntNow(final String key, final int value) {
        final Editor editor = getPreferences().edit();
        editor.putInt(key, value);
        editor.commit();
    }
    ...
    public static void putDoubleNow(final String key, final double value) {
        final Editor editor = getPreferences().edit();
        editor.putLong(key, Double.doubleToRawLongBits(value));
        editor.commit();
    }
    ...
    public static void putStringNow(final String key, final String value) {
        final Editor editor = getPreferences().edit();
        editor.putString(key, value);
        editor.commit();
    }
    ...
    public final static class Builder {
        ...
        public Builder setMode(final int mode) {
            if (mode == ContextWrapper.MODE_PRIVATE || mode == ContextWrapper.MODE_MULTI_PROCESS) {
                ...
                throw new RuntimeException("The mode in the SharedPreference can only be set too ContextWrapper.MODE_PRIVATE  or ContextWrapper.MODE_MULTI_PROCESS");
            }
